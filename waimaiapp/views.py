...
from waimaiapp.forms import UserForm, RestaurantForm, UserFormForEdit, MealForm
from django.contrib.auth import authenticate, login

from django.contrib.auth.models import User
from waimaiapp.models import Meal, Order
...
def restaurant_edit_meal(request, meal_id):
    ...
    # This allows you to edit the meal without having to add the image again
